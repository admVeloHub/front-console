...
const AgentAnalysis = ({ data, operatorMetrics, rankings, hideNames = false }) => {
  // Usar tema padrão do Console
  const theme = 'light' // Será integrado com o sistema de temas do Console
